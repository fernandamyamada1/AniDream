...
class GuideConfig:
    ...
    negative_text_in_SBP: str = "oversaturated, smooth, pixelated, foggy, hazy, blurry, bad structure, noisy, malformed"
    ...
    # Extra Module
    lora_name: Optional[str] = "anime" # LoRA model, change to null to exclude LoRA
    concept_name: Optional[str] = None  # Textual-Inversion concept
    lora_weight: float = 0.3
...
class TrainConfig:
    ...
    predefined_body_parts: str = "hands, face"
