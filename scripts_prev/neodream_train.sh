...
################################################## Configuration ######################################################
#!/bin/bash
#set path= /home3/staff/ya004545/.conda/envs/dw/bin/python3.11
# Configurations
text="${1}"
weight="${2:-0.3}"
...
# Call the specific Python interpreter
# /home3/staff/ya004545/.conda/envs/dw/bin/python3.11 your_python_script.py "$exp_root"
