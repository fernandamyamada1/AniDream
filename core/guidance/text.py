...
class TextAugmentation:
    ...
    def get_view_augmented_texts(self, text: str) -> list:
        ...
        # Text Augmentation: DreamWaltz
            ...
            texts = [
                f'front view of {text}',
                #f'front view of {text} with open mouth',
                f'side view of {text}',
                #f'side view of {text} with open mouth',
                f'back view of {text}',
                f'side view of {text}',
                #f'side view of {text} with open mouth',
                f'overhead view of {text}',
    ...
    def get_body_part_augmented_texts(self, text: str, start_idx: int):
        ...
        parts = ['head', 'face', 'face', 'mouth', 'arm_left', 'arm_right', 'hand_left', 'hand_right', 'foot_left', 'foot_right']
        part2index = {}
