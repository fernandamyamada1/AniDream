...
class BasicStableDiffusion:
    ...
    def load_lora(self):
        lora_name = "Linaqruf/anime-nouveau-xl-lora"

        try:
            # Download the LoRA weights from Hugging Face
            lora_path = hf_hub_download(repo_id=lora_name, filename="anime-nouveau-xl.safetensors")
